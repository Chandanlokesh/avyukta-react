...
//   return (
//     <GlassMorphicContainer className="flex flex-col items-center px-6 py-4 text-white bg-white/10 backdrop-blur-md rounded-lg shadow-lg font-explorer">
...
//         <h1 className="text-3xl md:text-7xl font-extrabold font-explorer bg-clip-text text-white  animate-fadeIn">
//           AVYUKTA - 2K25
//         </h1>
...
const CountdownTimer = ({ targetDate }) => {
  ...
  return (
    <GlassMorphicContainer className="flex flex-col items-center px-6 py-4 text-white bg-white/10 backdrop-blur-md rounded-lg shadow-lg font-explorer md:w-80">
      {/* <div className="flex items-center gap-2 text-md md:text-xl font-semibold text-purple-300">
        <Calendar size={20} /> Event Starts In:
      </div> */}
    ...
    <div className="relative w-full h-screen flex flex-col justify-center items-center text-white overflow-hidden">
      ...
      <div className="relative flex flex-col items-center text-center px-6 md:px-10 z-10">
        ...
        <p className="mt-3 text-md md:text-2xl text-white/80 flex items-center gap-2">
          <Calendar size={22} /> March 15, 2025
        </p>
